...
describe('Permissions (IT)', function () {
  it('fetchUmaTicket should give umaTicket token', async () => {
  ...
  it('fetchUmaTicket should give umaTicket token with resource filter', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
  ...
  it('fetchUmaTicket should give umaTicket token with scope filter', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
    ...
    expect(umaTicket).toBeDefined()
    expect(umaTicket.authorization?.permissions.length).toEqual(2)
    for (const permission of umaTicket.authorization!.permissions) {
      expect(permission.scopes).toEqual(['read'])
    }
  })

  it('KeycloakPermissionsProvider should check permissions', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
    ...
    const permissionsProvider = new KeycloakPermissionsProvider({ token: tokenReponseJson.access_token })
  ...
  it('KeycloakPermissionsProvider should check permissions using additional permission filter', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
  ...
  it('KeycloakPermissionsProvider should check permissions (as user)', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
  ...
  it('KeycloakPermissionsProvider should check permissions with decision response mode', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
    ...
    expect(await permissionsProvider.hasPermission('resource1#delete')).toBe(true)
    expect(await permissionsProvider.hasPermission('resource2#delete')).toBe(true)
    await expect(() => permissionsProvider.hasPermission('dummy')).rejects.toThrow('Resource with id [dummy] does not exist.')
  })

  it('KeycloakPermissionsProvider should check permissions for resource', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
  ...
  it('KeycloakPermissionsProvider should check permissions for resource with decision response mode', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
  ...
  it('KeycloakPermissionsProvider should check permissions for resource with decision response mode (as user)', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
    ...
    expect(await permissionsProvider.hasResourcePermission('resource1', 'read')).toBe(true)
    expect(await permissionsProvider.hasResourcePermission('resource2', 'read')).toBe(true)
    expect(await permissionsProvider.hasResourcePermission('resource1', 'delete')).toBe(false)
    expect(await permissionsProvider.hasResourcePermission('resource2', 'delete')).toBe(false)
  })

  it('KeycloakPermissionsProvider should get permissions', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
  ...
  it('KeycloakPermissionsProvider should get permissions for resource', async () => {
    const directGrant = new DirectGrant({
      client_id: 'app-authorization-services-test',
      client_secret: 'etkjHLXBRPpYSdebPqLM9XrPvkOzbv2d',
      scope: 'openid',
